...
\begin{frame}{Deep Learning}
	...
	\begin{figure}[t]
		\centering
		\subfigure[Deep Learning Structure]{
			\includegraphics[width=6cm]{image/dp.png}}
	\end{figure}
\end{frame}
...
\begin{frame}{Point Sets}
	...
	\begin{figure}[t]
		...
		\subfigure[2D Point Set]{
			\includegraphics[width=4.25cm]{image/timg.jpeg}}
...
\begin{frame}{Classification and Segmentation}
	...
	\begin{figure}
		\centering
		\subfigure[Room]{\includegraphics[width=4cm]{image/cs.png} }
...
\begin{frame}{Neural Network Based Methods}
	...
	\begin{figure}
		\centering
		\subfigure[3D ShapeNet]{\includegraphics[width=3cm]{image/shapenet.png}}
	\end{figure}
...
\begin{frame}{Neural Network Based Methods}
	...
	\begin{figure}
		\centering
		\subfigure[MVCNN]{\includegraphics[width=8cm]{image/mv.png}}
	\end{figure}
...
\begin{frame}{Traditional Point Cloud Processing}
	...
	\begin{figure}
		\centering
		\subfigure[A cup on the desk]{\includegraphics[width=6cm]{image/desk.png} }
		\subfigure[A part of leg]{\includegraphics[width=4cm]{image/leg.png}}
